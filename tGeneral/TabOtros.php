...
?>
 <br>
<div id = "boton" ><button id ="mosOculOtros" type="button" class="btn btn-primary btn-rounded nuevoRegistro">Nuevo</button>
</div>
	...
	<div class="form-group"> 
		<form class ="form" id="formularioVale" name ="fo3" action="crud/noEsUnPhpFalso.php"  method="POST" accept-charset="utf-8">
			<div class="form-row">
				...
				<div class="input validate rs1">
					<label class="labelFormu labelViaje" id="labelFechaComproVale" >  Fecha Comprobacion    </label>
				 	...
				 	<div class="form-row">					   
					    <div class="form-group col-md-2">
							...
							<?php 
								...
								$sql ='Select Concepto from concepto where (concepto !="transporte" ) and (Concepto !="Caseta")and (Concepto !="Estacionamiento")';
...
function RecargarTablaVales(){
	...
	$.getJSON(url,function(arregloEnviar){
		$.each(arregloEnviar, function(i,arregloEnviar){
			...
			+"<td>"+'<form action="PDF/PDFOtros.php" method=post target="popup" ><input name="folio" type="hidden" value='+Folio+'><input type="submit" class="btn btn-info btn-PDF" value=PDF /></form>'+"</td>";
			+"</tr>";
