...
//$sql = "SELECT DISTINCT folio, nombre, tipoFormulario, fechaComprobante,clienteObjetivo FROM tablageneral WHERE (nombre ='" .$nombre."' ) AND (tipoFormulario = 6 ) AND (fechaComprobante between '".$fAtras."' AND '".$fAct."')";
$sql = "SELECT DISTINCT folio, nombre, fechaComprobante FROM tablageneral WHERE (nombre ='" .$nombre."' ) AND (tipoFormulario = 6 ) AND (fechaComprobante between '".$fAtras."' AND '".$fAct."')";
...
$arregloEnviar[] = array('folio'=> $folio,'nombre'=> $nombre,'fechaComprobante'=> $fechaComprobante,'totalGeneral'=>$totalGeneral);
